...
export const SubscriptionContext = createContext<SubscriptionContextType>({
  isSubscribed: false,
  SUB_IDS: [
    'com.travel.ai.yearly.3',
    'com.travel.ai.monthly.3',
    'com.travel.ai.lifetime3',
  ],
  setisSubscribed: () => {},
  subsciptionList: [],
...
export const SubscriptionProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const hasSubscription = (userPurchases: Purchase[], availableSubs: (Product | Subscription)[]) => {
    for (const purchase of userPurchases) {
      if (purchase.productId === 'com.travel.ai.lifetime3' && purchase.transactionReceipt) {
