import { StyleSheet, TouchableOpacity, View, Pressable, Linking, SafeAreaView, Animated, Easing } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  selectedPlanView: {
    backgroundColor: '#002953', // Highlight selected item
  },
  expandedPlanView: {
